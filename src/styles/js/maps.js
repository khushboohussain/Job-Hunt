$(document).on('ready', function(){
	...
	var infowindow1 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err1.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	}); 

	// Add information window
	var infowindow2 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err2.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	}); 

	// Add information window
	var infowindow3 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err3.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	}); 

	// Add information window
	var infowindow4 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err4.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	}); 

	// Add information window
	var infowindow5 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err5.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	}); 

	// Add information window
	var infowindow6 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err6.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	});

	// Add information window
	var infowindow7 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err7.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	});

	// Add information window
	var infowindow8 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="map-can"><div class="map-candimg"><img src="images/resource/err8.jpg" alt="" /></div><div class="emply-resume-info"> <h3><a href="#" title="">Salman Ali</a></h3> <span><i>UX / UI Designer</i></span> <p>Istanbul / Turkey</p> </div></div>')
	});
